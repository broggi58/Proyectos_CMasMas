...
static int addNode(LinkedList* this, int nodeIndex,void* pElement)
{
    ...
    if(this!=NULL && nodeIndex > -1 && nodeIndex <= ll_len(this))
    {
        ...
        if(pNewNode != NULL)
        {
            ...
            {
                Node* pAuxNode = getNode(this, nodeIndex-1);
 ...
 * \param pList LinkedList* Puntero a la lista
 * \param pElement void* Puntero al elemento a ser tomado
 * \return int Retorna  (-1) Error: si el puntero a la lista es NULL
                        ( 0) Si funciono correctamente
 *
 */
...
int ll_set(LinkedList* this, int index,void* pElement)
{
    ...
    if(this!=NULL && index>=0 && index<= ll_len(this))
    {
        Node* pAuxNode = getNode(this,index);
    ...
    if(this!=NULL && index>=0 && index<ll_len(this))
    {
        ...
        if(pAuxNode!=NULL)
        {
            ...
            else
            {
                ...
                previousNode->pNextNode = pAuxNode->pNextNode;
                this->size--;
                result=0;
            }
...
LinkedList* ll_clone(LinkedList* this)
{
    ...
    if(this != NULL)
    {
        cloneList = ll_subList(this,0,size);
    }
...
LinkedList* ll_filterV2(LinkedList* this, int (*pFunc)(void* element,int nota),int notaReferencia)
{
   ...
   // flag=0;
   // returnAux=1;
    if(this==NULL || listaResultado==NULL)
    {
        return NULL;
    }
    else
    {
       // ObtenerNotaDeReferencia(this,&notaReferencia,)
         ...
         for(i=0;i<size;i++)
         {
            ...
            //ListElement(auxElement);
             ...
             if(pFunc(auxElement,notaReferencia)==1)
             {
    ...
    //ll_remove(listaResultado,0);
    return listaResultado;
}

int ll_sortV2(LinkedList* this, int (*pFunc)(void*,void*), int order,int (*pFunc2)(void*,void*))
{
    int result;
    int i;
    int j;
    ...
    if(this!= NULL && pFunc!=NULL && order>=0 && order<= 1)
    {
        ...
        for(i =0; i<size-1;i++)
        {
            for(j =i+1;j<size;j++)
            {
                ...
                {
                    if(pFunc2(ll_get(this,i),ll_get(this,j))>0 && order)
                    {
                        pAux = ll_get(this, i);
                        ll_set(this, i, ll_get(this, j));
                        ll_set(this, j, pAux);
                    }
                    else if(pFunc2(ll_get(this,i),ll_get(this,j))>0&& !order)
                    {
                        pAux = ll_get(this, i);
                        ll_set(this, i, ll_get(this, j));
                        ll_set(this, j, pAux);
